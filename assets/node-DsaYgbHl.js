import{i as e,r as t,s as n,t as r}from"./app-DihOlgHN.js";var i=JSON.parse(`{"path":"/operation/node.html","title":"","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1776090182746,"contributors":[{"name":"杨康","username":"","email":"851161583@qq.com","commits":1}],"changelog":[{"hash":"0b32d30b0d1a3d3bb32b48f80a9f229fb1cfb95b","time":1649132262000,"email":"851161583@qq.com","author":"杨康","message":"初始导入"}]},"filePathRelative":"operation/node.md"}`),a={name:`node.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h2 id="安装配置" tabindex="-1"><a class="header-anchor" href="#安装配置"><span>安装配置</span></a></h2><h3 id="_1、下载nginx" tabindex="-1"><a class="header-anchor" href="#_1、下载nginx"><span>1、下载nginx</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 进入目标文件夹</span></span>
